...
class AffiliationModel(Module):
    def __init__(self, config, vocab):
        ...
        """
        super(AffiliationModel, self).__init__()
        self.config = config
        self.vocab = vocab
        self.dim = 1
